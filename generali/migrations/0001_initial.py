# Generated by Django 4.0.3 on 2022-04-24 03:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ced_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
                ('serbas_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
                ('conv_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
                ('cert_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
                ('cargo_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
                ('renta_file', models.FileField(blank=True, null=True, upload_to='chapters/%Y/%m/%D/')),
